 ...
 */
public class JanelaGerenciarFornecedores extends javax.swing.JFrame {
// Declaração das variáveis
    private JTable tabela;
    private DefaultTableModel modelo = new DefaultTableModel();
    /**
     * Creates new form JanelaGerenciarFornecedors
     */
    public JanelaGerenciarFornecedores() {
        initComponents();
        criaTabela();
    ...
    private void criaTabela() {
        // criando tabela para adicionar fornecedores cadastrados
    ...
    private void preencherTabela() {
        // preenchendo tabela com fornecedores cadastrados
        modelo.setNumRows(0);
        FornecedorController pc = new FornecedorController();

        for (Fornecedor c : pc.listarFornecedor()) {
    ...
    private void botaoInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoInserirActionPerformed
        this.dispose();
        JanelaInserirFornecedor ji = new JanelaInserirFornecedor();
        ji.setVisible(true);
    ...
    private void botaoEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEditarActionPerformed
        ...
        JanelaEditarFornecedor ji = new JanelaEditarFornecedor(id);
        ji.setVisible(true);
        ji.setDefaultCloseOperation(1);
