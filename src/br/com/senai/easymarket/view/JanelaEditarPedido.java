 ...
 */
public class JanelaEditarPedido extends javax.swing.JFrame {
    Fornecedor id;
    private int idPedido;
    /**
     * Creates new form JanelaInserirPedido
     */
    public JanelaEditarPedido(int id) {
        initComponents();
        idPedido = id;
        setLocationRelativeTo(null);
        PedidoController pc = new PedidoController();
        pc.listarPedidoById(id);
        Pedido p = new Pedido();
        p = pc.listarPedidoById(id);
        
         campoCodigo.setText(p.getCodigo());   
         SimpleDateFormat data = new SimpleDateFormat("dd/MM/yyyy");
         String dataPedido = data.format(p.getDataPedido());
         String dataEntrega = data.format(p.getDataEntrega());
         campoDataPedido.setText(dataPedido);
         campoDataEntrega.setText(dataEntrega);
    ...
    private void initComponents() {
        ...
        LabelDescricao.setText("Editar Pedido");
    ...
    private void botaoCadastrarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCadastrarClienteActionPerformed
        ...
        c.setFornecedor(id);
        JOptionPane.showMessageDialog(null, "id do funcionario e "+id);
